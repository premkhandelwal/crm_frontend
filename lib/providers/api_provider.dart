...
class ApiProvider {
  ...
  /* Future<void> exportToExcel(
    ...
    // Sort the complaintList based on lot number
    ...
    sink.writeln(
      'Lot Number,BMS No,Return Date, Complaint, Missing Harness, BMS Details, Make, Customer, Behaviour, Reason/Comment, Solution, Tester, Status',
